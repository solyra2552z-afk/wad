...
-- Discord button (bottom left) - ปรับตำแหน่งใหม่
local DiscordButton = Instance.new("TextButton")
DiscordButton.Name = "DiscordButton"
DiscordButton.Size = UDim2.new(0, 85, 0, 30)
DiscordButton.Position = UDim2.new(0, 25, 1, -45)
...
DiscordIcon.Image = "rbxassetid://3926305904" -- ใช้ไอคอนเดียวกับ Key Icon
...
-- Website button (ข้างๆ Discord) - ปรับตำแหน่งใหม่
local WebsiteButton = Instance.new("TextButton")
WebsiteButton.Name = "WebsiteButton"
WebsiteButton.Size = UDim2.new(0, 85, 0, 30)
WebsiteButton.Position = UDim2.new(0, 120, 1, -45) -- เว้นระยะ 10px จาก Discord
...
WebsiteIcon.Position = UDim2.new(0, 8, 0.5, -8)
WebsiteIcon.BackgroundTransparency = 1
WebsiteIcon.Image = "rbxassetid://3926305904" -- ใช้ไอคอนเดียวกับ Key Icon
...
WebsiteText.Font = Enum.Font.GothamBold
